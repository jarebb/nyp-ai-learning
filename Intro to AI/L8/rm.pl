...
states([maramures,bucovina,moldova,dobrogea,muntenia,transilvania,oltenia,banat,crisana,basarabia]).


% Adjacent state list

adjacent(maramures,[bucovina, transilvania, crisana]).
adjacent(bucovina,[moldova, transilvania, maramures]).
adjacent(moldova,[bucovina, dobrogea, muntenia, transilvania]).
adjacent(dobrogea,[moldova, muntenia]).
adjacent(muntenia,[transilvania, moldova, dobrogea, oltenia]).
adjacent(transilvania,[maramures, bucovina, moldova, muntenia, oltenia, banat, crisana]).
adjacent(oltenia,[transilvania, muntenia, banat]).
adjacent(banat,[crisana, transilvania, oltenia]).
adjacent(crisana,[maramures, transilvania, banat]).
adjacent(basarabia,[moldova,dobrogea,bucovina]).
